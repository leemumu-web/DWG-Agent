...
本文件由 `cd backend && uv run python ../scripts/docs/generate_api.py` 从 FastAPI OpenAPI schema 生成。端点变更必须先修改代码和测试，再重新生成本文件。当前 OpenAPI 包含 **194 个 path、223 个 operation**。路由表只证明接口存在；功能开关、权限、外部依赖和真实样本仍可能阻止业务执行。
...
| `GET` | `/api/v1/data-admin/objects/tree` |
...
| `POST` | `/api/v1/users/{user_id}/restore-requests` |
...
| `GET` | `/api/v1/workflows/{workflow_id}/batch-exports/preview` |
| `POST` | `/api/v1/workflows/{workflow_id}/batch-exports` |
| `GET` | `/api/v1/workflows/{workflow_id}/batch-exports/{export_uid}` |
| `GET` | `/api/v1/workflows/{workflow_id}/batch-exports/{export_uid}/download` |
| `POST` | `/api/v1/workflows/{workflow_id}/batch-exports/{export_uid}/purge` |
| `GET` | `/api/v1/workflows/{workflow_id}/retention-preview` |
| `POST` | `/api/v1/workflows/{workflow_id}/retention-exports` |
| `GET` | `/api/v1/workflows/{workflow_id}/retention-exports/latest` |
| `GET` | `/api/v1/workflows/{workflow_id}/retention-exports/{export_uid}` |
| `GET` | `/api/v1/workflows/{workflow_id}/retention-exports/{export_uid}/download` |
| `POST` | `/api/v1/workflows/{workflow_id}/retention-exports/{export_uid}/purge` |
| `GET` | `/api/v1/workflows/{workflow_id}/download-archive` |
| `GET` | `/api/v1/workflows/{workflow_id}/stages/{stage_code}/download-archive` |
| `GET` | `/api/v1/workflows/{workflow_id}/stages/excel_stage1/download-result` |
| `GET` | `/api/v1/workflows/{workflow_id}/stages/excel_stage2/download-result` |
| `GET` | `/api/v1/workflows/{workflow_id}/stages/excel_stage2/download-reader-result` |
| `GET` | `/api/v1/workflows/{workflow_id}/stages/excel_stage2/download-box-reader-result` |
| `GET` | `/api/v1/workflows/{workflow_id}/stages/excel_stage3/download-result` |
| `GET` | `/api/v1/workflows/{workflow_id}/stages/excel_stage3/download-classification-result` |
| `GET` | `/api/v1/workflows/{workflow_id}/stages/excel_stage1/preflight` |
| `GET` | `/api/v1/workflows/{workflow_id}/stages/excel_stage2/preflight` |
| `GET` | `/api/v1/workflows/{workflow_id}/stages/excel_stage3/preflight` |
...
| `GET` | `/api/v1/workflows/{workflow_id}/dxf-classification/groups/{group_key}/files/{output_name}/download` |
| `GET` | `/api/v1/workflows/{workflow_id}/pl-xbox-split` |
| `GET` | `/api/v1/workflows/{workflow_id}/pl-xbox-split/runs/{run_id}/selective-export-preview` |
| `POST` | `/api/v1/workflows/{workflow_id}/pl-xbox-split/runs/{run_id}/selective-exports` |
| `GET` | `/api/v1/workflows/{workflow_id}/pl-xbox-split/runs/{run_id}/selective-exports/{export_uid}/download` |
| `GET` | `/api/v1/workflows/{workflow_id}/drawing-processing` |
| `GET` | `/api/v1/workflows/{workflow_id}/drawing-processing/runs/{run_id}/selective-export-preview` |
| `POST` | `/api/v1/workflows/{workflow_id}/drawing-processing/runs/{run_id}/selective-exports` |
| `GET` | `/api/v1/workflows/{workflow_id}/drawing-processing/runs/{run_id}/selective-exports/{export_uid}/download` |
