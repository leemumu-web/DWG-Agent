...
| `remnant_inventory` | partial | 6 | 22 | 2 | 材质目录、导入账本、异步解析与全厂共享余料状态 |
...
检查器验证路径存在、数组确定性排序、42 张 ORM 表唯一归属、165 个 HTTP operation 唯一归属、13 个 Celery 任务唯一归属、12 条任务路由稳定，以及目标能力的显式状态。
