...
- [x] **Step 1: 修改候选构造测试，要求 API 不再接收 RECT 决策**
...
- [x] **Step 2: 修改 writer 测试，要求 PartRow 无 file_value 且 K 列为空**
...
- [x] **Step 3: 修改端到端测试，要求全部文件单元格为空且无 RECT 报告**
...
- [x] **Step 2: 从 part 数据模型删除 file_value**
...
- [x] **Step 5: 删除 RECT 专属测试并运行 GREEN**
...
- [x] **Step 3: 清除后端测试 fixture 中的 RECT 示例**

将仅用于通用质量摘要测试的 `RECT未证明` 替换为中性的 `数据备注`，保持 warning/severe 聚合测试含义不变。

- [x] **Step 4: 更新 README 和 PROCESS**
