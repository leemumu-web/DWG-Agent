...
`steel-dxf-split-worker` 的 `d9e3409a76a88272641b61176259c7373de05f90` 受控快照接入
...
| 门禁 | 结果 | 当前证据 |
|---|---|---|
| Stage 源码镜像与算法回归 | **pass** | 源仓库 389 个 tracked blob 与内嵌快照逐字节一致，0 缺失、0 不一致；Stage 聚焦回归 **99 passed**。 |
