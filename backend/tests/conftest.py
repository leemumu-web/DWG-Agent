...
def _isolate_test_db(monkeypatch):
    ...
    monkeypatch.setattr(
        "app.modules.dxf_splitting.pl_execution.SessionLocal", TestSessionLocal
    )
    monkeypatch.setattr(
    ...
    monkeypatch.setattr("app.modules.workflows.retention_tasks.SessionLocal", TestSessionLocal)
