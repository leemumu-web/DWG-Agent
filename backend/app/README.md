...
Uvicorn 导入 `main.py` 后由 bootstrap 创建应用，显式装配 36 张 ORM 表、114 个 path/135 个 operation 和 7 个真实任务模块；业务请求进入对应 module，再经 platform adapter 访问 MySQL、Celery 和 Local/MinIO。
