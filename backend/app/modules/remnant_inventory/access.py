...
from app.platform.config.constants import ROLE_ADMIN, ROLE_OPERATOR, ROLE_SUPER_ADMIN


def can_use_remnants(user: User) -> bool:
    return bool({ROLE_SUPER_ADMIN, ROLE_ADMIN, ROLE_OPERATOR} & user_role_codes(user))
