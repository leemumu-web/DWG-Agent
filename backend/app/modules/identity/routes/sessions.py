"""Session, refresh-token and current-profile HTTP routes."""
...
from app.modules.identity.dependencies import CurrentUser, get_raw_access_token
from app.modules.identity.models.user import User
from app.modules.identity.schemas.auth import ChangePasswordRequest, LoginRequest, LoginResponse
from app.modules.identity.schemas.user import UserRead
...
def delete_current_session(
    ...
    from app.modules.identity.authentication import blacklist_access_token
...
def refresh_token(request: Request, response: Response, db: Session = Depends(get_db)):
    ...
    from app.modules.identity.authentication import is_token_blacklisted
    ...
    from app.modules.identity.authentication import is_token_stale_for_password_change
