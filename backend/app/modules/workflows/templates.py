    ...
    "linux_production": WorkflowTemplateRead(
        ...
        stages=[
            ...
            _stage(
                "pl_xbox_split",
                "PL / XBOX 拆板与独立校验",
                "处理分类确认的 PL 板材（原长单产物）与 XBOX 箱型构件（原长+焊接余量成对产物）。",
                execution_mode="automated",
            ...
            _stage(
                ...
                required_inputs=("source_excel", "processed_dxf", "bh_split_ledger"),
            ...
            _stage(
                "excel_stage3",
                "Excel 第三阶段处理",
                "异孔折判断对接：读取拆板后 DXF 进行图形分类，回填 part 表图形列。",
                execution_mode="automated",
