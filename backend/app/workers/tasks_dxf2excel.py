...
def extract_dxf_to_excel_task(self, job_id: int) -> dict[str, int | str]:
    ...
    run_dxf2excel_extraction(job_id, worker_name=worker_name)
    return {"job_id": job_id, "pipeline": "dxf2excel"}
