      ...
      <div className="dashboard-manual-panel">
        ...
        <div className="dashboard-manual-grid">
          <ManualList title="上传顺序" items={[
            ...
            '单次最多上传 5000 张图纸。文件夹超过 5000 张图纸时，只接收浏览器列出的前 5000 张，其余图纸不上传并显示红色警告；此时要先确认被忽略的图纸是否属于本批。',
          ...
          <ManualList title="冻结前核对" items={[
            ...
            '多工作表、忽略非 DWG、超过 5000 张图纸等提醒必须读完，不能只看“上传成功”。',
      ...
      <div className="dashboard-manual-panel">
        ...
        <div className="dashboard-manual-grid">
          ...
          <ManualList title="当前能力边界" items={[
            '资料入库、图纸分类、BH/BOX 拆板、Excel 第一阶段和 BH/BOX 左右进深化是当前可操作生产能力。',
            'Excel 第二阶段先核验冻结 BH 图纸和第一阶段正式结果，再分别下载读取表与深化 Excel；完成后仍须由人工确认设计屏障。',
            'CAM 工作包、Windows CAM、结果接纳和交付归档显示“等待上线”时，不提供模拟执行或虚假完成按钮。',
      ...
      <div className="dashboard-production-guide">
        ...
        <Card title="开工前请核对" className="dashboard-production-guide__checklist">
          <ul>
            ...
            <li>单次最多接收 5000 张图纸；超过时页面会明确提示本次实际接收范围。</li>
