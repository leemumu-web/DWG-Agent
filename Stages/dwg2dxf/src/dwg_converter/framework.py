...
- 平台执行入口位于
  `backend/app/modules/cad_processing/dwg_to_dxf/execution.py`；错误码契约由同目录
  `contracts.py` 复用，ODA 健康状态由
  `backend/app/modules/operations/data_catalog/system_routes.py` 暴露。
