...
INPUT_DIR="${PROJECT_ROOT}/convert/input_dwg"
OUTPUT_DIR="${PROJECT_ROOT}/convert/output_dxf"
...
if [[ ${VERBOSE} -eq 1 ]]; then
    UV_ARGS+=(python -m dwg_converter -v)
else
    UV_ARGS+=(python -m dwg_converter)
fi
