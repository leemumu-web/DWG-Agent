...
run_gate "聚焦后端与脚本回归" bash -c \
    'cd backend && uv run python -m pytest -q tests/infrastructure/test_scripts.py tests/infrastructure/test_forward_to_win11_script.py tests/infrastructure/test_compose.py tests/infrastructure/test_ci.py tests/infrastructure/test_server_release.py tests/files/test_file_service.py tests/files/test_file_transfer_service.py tests/files/test_adversarial_files.py tests/contracts/test_frontend_contract.py' \
    -- "$PROJECT_ROOT"
